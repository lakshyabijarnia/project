...
class GLevelPSDApp(tk.Tk):
    ...
    def plot_glevels(self):
        if self.data is not None:
            ...
            toolbar = NavigationToolbar2Tk(None, self.glevel_canvas)  # Create toolbar once outside the loop
            ...
            for i in range(0, min(channel_data.shape[1], 24), 3):
                ...
                plot.toolbar = toolbar  # Use the same toolbar for all plots
    ...
    def plot_psd_from_selection(self):
        if self.data is not None:
            ...
            toolbar = NavigationToolbar2Tk(None, self.psd_canvas)
