...
class GLevelPSDApp(tk.Tk):
    ...
    def create_glevel_tab(self):
        ...
        # Button to show peaks
        self.show_peaks_button = ttk.Button(self.glevel_frame, text="Show Peaks", command=self.show_peaks)
        self.show_peaks_button.pack(side=tk.TOP, padx=10, pady=10)
